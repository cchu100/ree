...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.cookiesEarned=99999999999999999999;//all cookies earned during gameplay
		Game.cookies=99999999999999999999;//cookies
		Game.cookiesd=99999999999999999999;//cookies display
		Game.cookiesPs=99999999999999999999;//cookies per second (to recalculate with every new purchase)
		Game.cookiesReset=99999999999999999999;//cookies lost to resetting (used to determine prestige and heavenly chips)
		Game.cookieClicks=99999999999999999999;//+1 for each click on the cookie
		Game.goldenClicks=99999999999999999999;//+1 for each golden cookie clicked (all time)
		Game.goldenClicksLocal=99999999999999999999;//+1 for each golden cookie clicked (this game only)
		Game.missedGoldenClicks=99999999999999999999;//+1 for each golden cookie missed
		Game.handmadeCookies=99999999999999999999;//all the cookies made from clicking the cookie
		...
		Game.heavenlyChips=99999999999999999999;//heavenly chips the player currently has
		Game.heavenlyChipsDisplayed=99999999999999999999;//ticks up or down to match Game.heavenlyChips
		Game.heavenlyChipsSpent=99999999999999999999;//heavenly chips spent on cookies, upgrades and such
		Game.heavenlyCookies=99999999999999999999;//how many cookies have we baked from chips (unused)
